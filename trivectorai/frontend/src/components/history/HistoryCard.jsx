...
export default function HistoryCard({ item, onOpen, onDelete }) {
  ...
  return (
    <Link to={`/app/results/${item.id}`} state={{ result: result }} onClick={() => onOpen?.(item)}>
      <Card hoverable className="p-3">
        <div className="mb-2 flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={handleDelete} className="text-[var(--text-secondary)]">
